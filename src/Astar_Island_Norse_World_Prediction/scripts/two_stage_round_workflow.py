...
def main() -> None:
    ...
    parser.add_argument("--predictor-mode", choices=["baseline", "spatial", "spatial_unet", "unet", "convlstm", "unet_spatial", "attn_unet", "attn_unet_spatial", "ensemble", "socio_unet", "gnn", "time_socio_unet"], default="time_socio_unet")
    parser.add_argument("--query-policy", choices=["grid", "random", "entropy", "grid_then_entropy"], default="random")

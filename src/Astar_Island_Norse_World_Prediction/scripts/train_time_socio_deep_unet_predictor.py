...
def main():
    ...
    parser.add_argument("--out-model", default="data/reports/time_socio_deep_unet_predictor.pth", type=str)
    ...
    print(f"Loaded {len(dataset)} base samples for Time-Socio Deep U-Net training.")
    dataloader = DataLoader(dataset, batch_size=args.batch_size, shuffle=True)
    
    model = TimeSocioDeepUNet()
